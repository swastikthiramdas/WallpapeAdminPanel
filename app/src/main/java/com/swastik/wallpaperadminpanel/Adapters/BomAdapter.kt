...
class BomAdapter(val requiredcontext: Context, private val list: ArrayList<BomModel>) :
    RecyclerView.Adapter<BomAdapter.viewholder>() {
    ...
    class viewholder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val delete = view.findViewById<ImageView>(R.id.bom_delete)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewholder {
        val itemview =
            LayoutInflater.from(requiredcontext).inflate(R.layout.item_bom, parent, false)
    ...
    override fun onBindViewHolder(holder: viewholder, position: Int) {
        ...
        holder.delete.setOnClickListener {
            ...
            dialog.setPositiveButton("YES", DialogInterface.OnClickListener { dialogInterface, i ->
                ...
                db.collection("bestofthemonth").document(currentitem.id).delete()
                    .addOnCompleteListener {
                        if (it.isSuccessful) {
                            Toast.makeText(requiredcontext, "Deleted Succsesfully", Toast.LENGTH_SHORT)
                                .show()
                        } else {
                            Toast.makeText(requiredcontext, "Something went wrong", Toast.LENGTH_SHORT)
                                .show()
                        }
